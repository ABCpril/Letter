...
public class EaseSmileUtils {
    ...
    public static final Map<String, Pattern> emojisPattern = new HashMap<>();
    public static final Map<String, Integer> emojisRes = new HashMap<>();
    ...
    public static void addPattern(String emojiText, Object icon) {
        ...
        emoticons.put(pattern, icon);
        emojisPattern.put(emojiText, pattern);
        emojisRes.put(emojiText, (Integer) icon);
    }
